...
public class WageCalculation {
    ...
    // Paths to data files
    private static final String EMPLOYEES_DATA_PATH = "src/main/java/main/data/employee_information.csv";
    private static final String ATTENDANCE_DATA_PATH = "src/main/java/main/data/employee_attendance.csv";
